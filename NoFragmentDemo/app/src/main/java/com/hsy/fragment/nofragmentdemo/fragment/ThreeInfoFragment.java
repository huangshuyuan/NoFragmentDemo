...
/**
 * 作者：huangshuyuan on 2017/5/12 20:49
 * 邮箱：hshuyuan@foxmail.com
 */

public class ThreeInfoFragment extends NoFragment {
    Toolbar toolbar;
    Button button;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_three_info, container, false);
    }
